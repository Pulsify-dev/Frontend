...
const PulsifyTrackRow = ({ track, onLike, onRepost, isLiked, isReposted, hideContext = false }) => {
        ...
        <div className="sc-track-body">
          ...
          <div className="sc-track-footer">
            <div className="sc-track-actions">
              ...
              <button className={`sc-btn ${isReposted ? 'active' : ''}`} onClick={() => onRepost(track.trackId)}>𓅄 {isReposted ? track.reposts + 1 : track.reposts}</button>
