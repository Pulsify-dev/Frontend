 ...
 */
export const mockRegister = async ({ email, password, displayName, username, age, gender }) => {
  await delay(1500);
...
export const mockOAuthLogin = async (provider) => {
  ...
  const mockOAuthUsers = {
    google: {
      ...
      avatarUrl: 'https://i1.sndcdn.com/avatars-000007873027-0ror16-t500x500.jpg',
    },
    facebook: {
      email: 'user@facebook.com',
      displayName: 'Facebook User',
      avatarUrl: 'https://i1.sndcdn.com/avatars-000003004402-pg96oj-t500x500.jpg',
    },
    apple: {
      email: 'user@icloud.com',
      displayName: 'Apple User',
      avatarUrl: 'https://i1.sndcdn.com/avatars-000001411498-z0flxc-t500x500.jpg',
    },
  };
