...
const DiscoveryFeedPage = () => {
  ...
  const Carousel = ({ title, subtitle, children, viewAllLink }) => (
    <section className="sc-discover-shelf">
      <div className="sc-shelf-header">
        ...
        {viewAllLink && (
          <a href={viewAllLink} className="sc-shelf-viewall">
            View all
          </a>
        )}
      </div>
      <div className="sc-carousel-row">{children}</div>
    </section>
  );
  ...
  const TrackCard = ({ track, onReport }) => {
    const art =
      track.artwork_url || track.coverArt || "https://via.placeholder.com/180";
    const title = track.title;
    const artist =
      track.artist_id?.display_name ||
      track.artist_id?.username ||
      track.artist?.name ||
      "";
    ...
    return (
      <div className="sc-discover-card">
        <div
          className="sc-discover-card-art"
          onClick={() => handleGoToTrack(track)}
          style={{ cursor: "pointer" }}
        >
          <img src={art} alt={title} />
          <button
            className="sc-discover-card-play"
            onClick={(e) => {
              e.stopPropagation();
        ...
        <div
          className="sc-discover-card-title"
          onClick={() => handleGoToTrack(track)}
          style={{ cursor: "pointer" }}
        >
          {title}
        ...
        {artist && (
          <div
            className="sc-discover-card-artist"
            onClick={() => {
      ...
      <div className="sc-discover-content">
        ...
        <div className="sc-discover-main">
          ...
          {freshUploads.length > 0 && (
            <Carousel
              title="Fresh uploads"
              subtitle="Latest tracks on the platform"
            >
        ...
        <aside className="sc-discover-sidebar">
          ...
          <div className="sc-sidebar-widget">
            <div className="sc-widget-header">
              ...
              <a href="#" className="sc-widget-header-link">
                Refresh list
              </a>
            </div>
                  ...
                  <div className="sc-follow-row" key={userId}>
                    ...
                    >
                      <div className="sc-follow-name">
                        ...
                        {user.is_verified && (
                          <span className="sc-verified-dot">●</span>
                        )}
                      </div>
          ...
          <div className="sc-sidebar-widget">
            ...
            <div className="sc-list-items">
              {history.length > 0 ? (
                ...
                <div
                  style={{ color: "#888", padding: "10px 0", fontSize: "13px" }}
                >
          ...
          <div className="sc-sidebar-footer-links">
            ...
            <a href="#">Cookie Policy/Imprint</a> · <a href="#">Charts</a> ·{" "}
            <a href="#">Newsroom</a>
